...
public:
	...
	virtual void process(vector_reg_read_event_t *event) = 0;
	virtual void process(vector_reg_write_event_t *event) = 0;
};
...
public:
	...
	virtual void process(vector_retire_event_t *event) = 0;
};
