...
decode_t::decode_t(std::string _name, io::json _config, scheduler_t *_scheduler)
	...
	bp_input_port = create_port<persistent_port_t<bool>>("bp_input_port");
	bp_output_port = create_port<persistent_port_t<bool>>("bp_output_port");
	...
	insn_squash_input_port = create_port<signal_port_t<insn_squash_event_t *>>("insn_squash_input_port");
	insn_squash_output_port = create_port<signal_port_t<insn_squash_event_t *>>("insn_squash_output_port");
